...
router.get(
  ...
  mailConfirmation.userEmailVerification
);
router.get(
  "/forUserConfirmationEmail/:userEmail",
  mailConfirmation.forUserConfirmationEmail
);
...
router.post("/forgetPassword", mailConfirmation.forgetPassword);
